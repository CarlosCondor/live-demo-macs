...
(function () {
    ...
    MashupPlatform.wiring.registerCallback("inputIssue", function (issueString) {
        ...
        case "high":
            icon = "images/fillingCritical.png";
            break;
        case "critical":
            icon = "images/batteryCritical.png";
            break;
        case "warning":
            icon = "images/batteryWarning.png";
            break;
        default:
            icon = "images/nodeOK.png";
        }
    ...
    var setInfoWindow = function setInfoWindow(issue) {
        ...
        infoWindow += "<br />";
        infoWindow += "<span><b>Node Id:</b> " + issue.affectedId + "</span>";
        infoWindow += "<br />";
