...
/******************************************************************************/
    ...
    var condValues = ['Latitud', 'Longitud'];
...
/******************************************************************************/
    ...
    var doInitialSubscription = function doInitialSubscription() {
        ...
        this.entity_type = MashupPlatform.prefs.get('entity_type');
        this.subscription_type = MashupPlatform.prefs.get('subscription_type');
        if (this.subscription_type=='ONCHANGE') {
            condValues = MashupPlatform.prefs.get('subscription_option').split(',');
        } else {
            condValues = [MashupPlatform.prefs.get('subscription_option')];
        }
        this.connection = new NGSI.Connection(this.ngsi_server, {
            ngsi_proxy_url: this.ngsi_proxy
        });

        var types = [this.entity_type];
        var entityIdList = [];
        var entityId;
